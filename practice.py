...
# # poliwag = Pokemon('Poliwag', 60, 'water', 'grass', ('none', 0), ('Water Gun', 30))
# # bulbasaur = Pokemon('Bulbasaur', 90, 'grass', 'fire', ('water', 10), ('Vine Whip', 40))
...
#         poke1.take_damage(poke2.moves[1], poke1.energy_type, poke1.resistence[1])
#         poke2.take_damage(poke1.moves[1], poke2.energy_type, poke2.resistence[1])
#         #break#
